		...
		<main className="flex-1 w-full max-w-[1000px] mx-auto pt-32 pb-20 px-6 lg:px-10">
			<article className="flex flex-col w-full">
				...
				<div className="mb-20 text-center max-w-4xl mx-auto">
					<h1 className="font-serif text-6xl md:text-8xl font-normal text-[#221F1D] dark:text-[#EEECE5] leading-[0.95] tracking-tight mb-10">
						{post.title.main} <br />
						<i className="font-serif italic text-[#D2603C] font-light pr-2">
							{post.title.accent}
						</i>
					</h1>
					<p className="text-xl md:text-2xl text-[#221F1D]/60 dark:text-[#EEECE5]/60 leading-[1.6] font-light max-w-2xl mx-auto">
						{post.subtitle}
					</p>
				</div>

				{/* Hero Image */}
				<div className="w-full aspect-[16/9] md:aspect-[2.4/1] rounded-3xl overflow-hidden mb-24 relative shadow-2xl group border border-[#E6E3DB]/30 dark:border-white/5">
					<div className="absolute inset-0 bg-gradient-to-t from-[#221F1D]/30 to-transparent z-10"></div>
					<Image
						src={post.heroImage}
				...
				{/* Content */}
				<div className="prose prose-lg max-w-2xl mx-auto prose-headings:font-serif prose-headings:font-normal prose-headings:text-[#221F1D] dark:prose-headings:text-[#EEECE5] prose-p:text-[#221F1D]/80 dark:prose-p:text-[#EEECE5]/80 prose-p:leading-[1.9] prose-p:font-normal prose-a:text-[#D2603C] prose-a:no-underline hover:prose-a:underline prose-a:transition-colors prose-strong:text-[#221F1D] dark:prose-strong:text-[#EEECE5] prose-strong:font-semibold prose-code:text-[#A63D1E] dark:prose-code:text-[#D2603C] prose-code:bg-[#EEECE5] dark:prose-code:bg-white/10 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:font-mono prose-code:before:content-[''] prose-code:after:content-[''] prose-h2:text-4xl prose-h2:md:text-5xl prose-h2:mt-24 prose-h2:mb-10 prose-h2:leading-[1.15]">
					{children}
				</div>
